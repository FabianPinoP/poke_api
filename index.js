...
function addPokemon(pokemon){
    ...
    $('#pokedex').append('<li>' + pokemon.name + '</li>' + 
                         '<button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#pokemon-data" data-pokemon='+ pokemon.name +'> Quiero saber mas de este pokemon' + '</button>')
}
...
//3. crear modal 
//4. crear funcion que traiga info de los pokemons  (tipo, habilidades, moviminetos, generaciones)